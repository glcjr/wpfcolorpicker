...
namespace WPFColorPickerLib
{
  ...
  ///  Enhanced by Gary Cole (June 2016) 
  ///  - added the ability to make initial colors from Hexcode, SYstem.Drawing.Color, Brush
  ///  - added the ability to retrieve the new color as Hex, System.Drawing.Color, brush
  /// </summary>
